...
export function PublishingExplaination() {
  ...
  return (
    <FormSection title={t('kubernetes.applications.create.services.explanation.title')} isFoldable titleSize="sm">
      <div className="mb-4 flex w-full flex-col items-start lg:flex-row">
        <img
          src={ingressDiagram}
          alt={t('kubernetes.applications.create.services.explanation.imageAlt')}
          width={646}
        ...
        <div className="text-muted ml-8 basis-1/2 text-xs">
          <Trans i18nKey="kubernetes.applications.create.services.explanation.content">
