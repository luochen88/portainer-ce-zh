      ...
      <div className="col-sm-12 flex flex-col gap-y-5">
        ...
        <DashboardGrid>
          <DashboardItem
            ...
            type={t('kubernetes.common.resourceTypes.namespace')}
          ...
          <DashboardItem
            ...
            type={t('kubernetes.common.resourceTypes.application')}
          ...
          <DashboardItem
            ...
            type={t('kubernetes.common.resourceTypes.service')}
          ...
          <DashboardItem
            ...
            type={t('kubernetes.common.resourceTypes.ingress')}
            pluralType={t('kubernetes.common.resourceTypes.ingresses')}
          ...
          <DashboardItem
            ...
            type={t('kubernetes.common.resourceTypes.configMap')}
          ...
          <DashboardItem
            ...
            to="kubernetes.configurations"
            params={{ tab: 'secrets' }}
            type={t('kubernetes.common.resourceTypes.secret')}
          ...
          <DashboardItem
            ...
            type={t('kubernetes.common.resourceTypes.volume')}
